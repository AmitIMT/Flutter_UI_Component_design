...
// import 'package:google_fonts/google_fonts.dart';
 ...
 const secondary = Color(0xFF3B76F6);
   const accent = Color(0xFFD6755B);
   const textDark = Color(0xFF53585A);
   const textLigth = Color(0xFFF5F5F5);
   const textFaded = Color(0xFF9899A5);
   const iconLight = Color(0xFFB1B4C0);
   const iconDark = Color(0xFFB1B3C1);
   const textHighlight = secondary;
   const cardLight = Color(0xFFF9FAFE);
   const cardDark = Color(0xFF303334);
